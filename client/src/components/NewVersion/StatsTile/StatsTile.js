...
export const StatsTile = ({ dateFilter, expenses }) => {

  const thisWeekExpenses = getThisWeekExpenses(expenses);
  const { totalExpensesAmount } = getCategoriesData(thisWeekExpenses);
  console.log('totalExpensesAmount-->', totalExpensesAmount);


  return (
    <div className='stats__tile__container'>
      <div className='stats__tile__header'>
        <div className='stats__tile__header__left'>
          <div>{dateFilter}</div>
        </div>
